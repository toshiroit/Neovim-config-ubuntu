...
**Warning** : Đây không phải cài đặt của tôi , tôi clone 1 từ người trên Youtube và config lại cho ubuntu 22.04 sử dụng 
...
Link tài về và cài đặt  [Neovim](https://neovim.io/) (Yêu cầu phiên bản trên 0.7 ) 
...
## Cách setup shell cho macOs và linux 
